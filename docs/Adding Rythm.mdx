...
<Tabs
  ...
  <TabItem value="r1">
    ...
    <ul>
      ...
      <li>Rythm is our main bot used by the most servers. This bot and most of its features are available to the public for free.
          You can invite Rythm by <a href="https://rythm.fm/invite">clicking here</a>.</li>
    </ul>
  </TabItem>
  <TabItem value="r2">
    ...
    <ul>
      <li>Prefix: <code>&gt;</code></li>
      <li>Rythm 2 is the secondary Rythm bot, used by the second most number of servers. It is identical in functionality to Rythm 1, the only difference being the prefix.
          You can invite Rythm 2 by <a href="https://rythm.fm/invite2">clicking here</a>.</li>
    </ul>
  </TabItem>
  <TabItem value="r3">
    ...
    <ul>
      <li>Prefix: <code>&</code></li>
      <li>Rythm 3 is the third Rythm bot. This bot is premium only, and requires a subscription to use in your server.
          You can invite Rythm 3 by <a href="https://rythm.fm/invite3 ">clicking here</a>.</li>
    </ul>
  </TabItem>
  <TabItem value="r4">
    ...
    <ul>
      <li>Prefix: <code>%</code></li>
      <li>Rythm 4 is the fourth Rythm bot. This bot is premium only, and requires a subscription to use in your server.
          You can invite Rythm 4 by <a href="https://rythm.fm/invite4">clicking here</a>.</li>
    </ul>
  </TabItem>
  <TabItem value="r5">
    ...
    <ul>
      <li>Prefix: <code>&</code></li>
      <li>Rythm 5 is the fifth Rythm bot. This bot is premium only, and requires a subscription to use in your server.
          You can invite Rythm 5 by <a href="https://rythm.fm/invite5">clicking here</a>.</li>
    </ul>
  </TabItem>
</Tabs>
