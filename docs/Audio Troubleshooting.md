...
If you can't hear Rythm or receive distorted sounds in any server (including the [Official Rythm server](https://rythm.fm/support)), it's probably due to your local audio device settings.
